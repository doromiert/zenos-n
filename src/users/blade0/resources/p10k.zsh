# Generated by Powerlevel10k configuration wizard on 2026-01-05 at 09:00 CET.
...
() {
  ...
  #   typeset -g POWERLEVEL9K_DIR_WORK_NON_EXISTENT_BACKGROUND=5
  ...
  typeset -g POWERLEVEL9K_CHEZMOI_SHELL_BACKGROUND=5
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_AZURE_OTHER_BACKGROUND=5
  # Custom icon.
